            ...
            <div className="flex justify-center">
                ...
                <motion.div initial={{x: -100}} whileInView={{x:0}} transition={{ duration: 0.5 }} className="bg-black/10 w-75 relative left-1/2 -translate-x-1/2 flex flex-col justify-center rounded-2xl">
                    <div className="p-4 flex flex-col justify-center gap-5">
                        ...
                        <div className="flex justify-center h-10 gap-5">
                            <img loading="lazy" src="/images/html.svg" alt="html" width={40} height={40} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/css.svg" alt="css" width={40} height={40} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/tailwind.svg" alt="html" width={40} height={40} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/typescript.svg" alt="typescript" width={40} height={40} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/astro.ico" alt="astro" width={40} height={40} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                        </div>
                ...
                <motion.div initial={{x: -100}} whileInView={{x:0}} transition={{ duration: 0.5, delay: 0.1}} className="bg-black/10 w-75 relative left-1/2 -translate-x-1/2 rounded-2xl">
                        ...
                        <div className="flex justify-center h-10 gap-5">
                            <img loading="lazy" src="/images/react.svg" alt="react" width={40} height={20} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/tanstack.svg" alt="tanstack" width={40} height={20} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer invert"/>
                            <img loading="lazy" src="/images/typescript.svg" alt="typescript" width={40} height={20} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/sanity.png" alt="sanity" width={40} height={20} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                            <img loading="lazy" src="/images/framer.png" alt="framer" width={40} height={20} className="hover:scale-[1.1] transition-all duration-200 cursor-pointer" />
                        </div>
