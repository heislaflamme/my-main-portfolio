  ...
  return (
    <>
      <div className="flex flex-col justify-center gap-2 overflow-hidden">
        <motion.div initial={{scale: 0.5 }} whileInView={{ scale: 1}} whileHover={{ y: -5 }} className=" bg-black/20 p-4 rounded-2xl">
          <strong>Frontend Development</strong>
          <motion.div initial={{ width: 0}} whileInView={{ width: "100%" }} className="bg-black/50 h-px rounded-4xl"></motion.div>
