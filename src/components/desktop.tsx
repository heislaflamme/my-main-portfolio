    ...
    <>
      <div className="flex flex-col gap-3">
        <a
          ...
          className="hover-white cursor-pointer active:scale-[0.9] transition-all duration-300 w-20 flex flex-col justify-center p-2 rounded"
        >
          <img
            loading="eager"
            src="/images/word.png"
      ...
      <div className="hero-header flex flex-col absolute w-full pointer-events-none h-full justify-center items-center">
        <header
          ref={headerRef}
          className="hero-text text-[8vw] text-white pointer-events-auto"
          style={{ opacity: 0.01 }}
        >
          HEY I'M CHIDUBEM
        </header>
        <motion.p
          ...
          className="hero-p pointer-events-auto hover:scale-[1.05] transition-all duration-200 text-[2vw] text-white"
        >
